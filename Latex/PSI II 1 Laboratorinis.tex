...
\begin{longtable}{ | p{0.1\textwidth}|p{0.45\textwidth}|p{0.15\textwidth}| }  \hline
	...
	FR 9 & Sistema vartotojui suteikia galimybę peržiūrėti dabartines oro salygas ir ateities orų prognozę & - \\ \hline
	FR 10 & Paskyroje vartotojas gali rašyti žinutes kitiems kurorto svečiams, adminisntracijai ir maisto į kambarį tarnybai & - \\ \hline
	...
	FR 12 & Sistema administratoriui suteikia galimybę stebėti duombazės objektų būseną ir ją keisti & - \\ \hline
	FR 13 & Sistema suteikia vartotojui galimybę peržiūrėti kurorto statistika. Rodomi statistiniai duomenys turi būti patvirtinti administracijos ir kurorto vadovo. & - \\ \hline
	FR 14 & Sistemoje vartotojui suteikia galimybę peržiūrėti paslaugų kainas, tiekėjų sąrašą ir kiekvienos įrangos technines charakteristikas & - \\ \hline
	FR 15 & Sistema administratoriui suteikia galimybę skaityti sutarčių ataskaitas. & - \\ \hline
	FR 16 & Sistema vartotojui suteikia galimybę užsisakyti papildomas paslaugas, kurių jis dar neužsakė & Nefunkcinis? \\ \hline
	FR 17 & Sistema leidžia vartotojui peržiųrėti visas jo pasirašytas sutartis & - \\ \hline
